...
export class ProductsAPIService {
   ...
   */
  public getProduct(
    requestParameters: GetProductRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<Product>;
  ...
  public searchProducts(
    requestParameters: SearchProductsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ...
  public searchProducts(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<HttpResponse<ProductPageResult>>;
  public searchProducts(
    requestParameters: SearchProductsRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<HttpEvent<ProductPageResult>>;
  public searchProducts(
    requestParameters: SearchProductsRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (productSearchCriteria === null || productSearchCriteria === undefined) {
      throw new Error(
        'Required parameter productSearchCriteria was null or undefined when calling searchProducts.'
      );
    }
    ...
    return this.httpClient.request<ProductPageResult>(
      'post',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
